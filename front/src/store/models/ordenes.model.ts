...
export const ordenesModel: OrdenesModel = {
  ...
  fetchAll: thunk(async (actions, params) => {
    console.log("[Store] fetchAll ordenes called with params:", params);
    actions.setLoading(true);
    actions.setError(null);
    try {
      const ordenes = await ordenesService.getAll(params);
      console.log("[Store] fetchAll ordenes success:", ordenes.length, "items");
      ...
      console.error("[Store] fetchAll ordenes error:", error);
